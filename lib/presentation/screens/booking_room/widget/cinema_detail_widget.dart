...
class CinemaDetailWidget extends StatelessWidget {
  final List<Marker> markers;
  final CinemaDetailResponse cinemaDetail;

  const CinemaDetailWidget({
    super.key,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AppText(cinemaDetail.name.toUpperCase(), fontSize: 16.sp, fontWeight: FontWeight.bold, color: AppColors.black),
